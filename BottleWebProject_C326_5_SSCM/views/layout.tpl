...
<body>
    <div class="container">
        ...
        <div class="header">
            <div class="header-content-custom" style="display: flex; flex-direction: column; width: 100%;">
                
                <div style="display: flex; justify-content: flex-start; align-items: center; width: 100%; flex-wrap: wrap; margin-bottom: 0px !important;">
                ...
                <div style="display: flex; justify-content: flex-start; padding: 0; margin-top: 0; width: 100%;">
                    <nav class="nav">
                        <ul style="display: flex; list-style: none; margin: 0 !important; padding: 0 !important; gap: 10px; flex-wrap: wrap;">
            ...
            </div> </div> <div class="body-content" style="margin-top: 20px;">
            {{!base}}
        </div>
